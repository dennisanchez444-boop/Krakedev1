...
calcularValorTotal = function () {
    ...
    */
    ...
    if (esProductoValido(producto)&esCantidadValida(cantidad)&esPrecioValido(precioProducto)) {
        return true;
    } else {
...
esProductoValido = function (nombreProducto) {
    ...
    } else if (nombreProducto <= 10) {
        mostrarTexto("Error1", "");
    } else {
        error = true;
        mostrarTexto("Error1", "NO PUEDE TENER MAS DE 10 CARACTERES");
    }
    return error;
}
...
esCantidadValida = function (cantidad) {
    if (cantidad == "") {
        ...
        error = true;
        mostrarTexto("lblError2", "DEBE SER UN NÚMERO ENTRE 0 Y 100");
    }
    return error;
}
esPrecioValido = function (precioProducto) {
    if (precioProducto == "") {
        ...
        error = true;
        mostrarTexto("lblError3", "DEBE SER UN NÚMERO ENTRE 0 Y 50");
    }
    return error;
}
